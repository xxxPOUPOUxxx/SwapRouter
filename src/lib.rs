...
#[derive(Debug)]
pub struct SwapRouterProcessor {
    verbose: bool,
    processed_count: usize,
}

impl SwapRouterProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting SwapRouter processing");
    
    let mut processor = SwapRouterProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = SwapRouterProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = SwapRouterProcessor::new(false);
